"""A hello-world filter plugin in correctnamespace.correctname."""
...
DOCUMENTATION = """
    name: hello_world
    author: Correctnamespace Correctname
    version_added: "1.0.0"
...
- name: Display a hello message
  ansible.builtin.debug:
    msg: "{{ 'ansible-creator' | correctnamespace.correctname.hello_world }}"
"""
